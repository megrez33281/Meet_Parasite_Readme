...
![1726210494494](image/README/1726210494494.png)
...
- 白板工具欄：
  ...
  - 儲存（翻頁）面板：![儲存（翻頁）面板](image/README/儲存（翻頁）面板.png)
    ...
    - 匯出：![匯出](image/README/匯出.png)
      ...
      - PDF：儲存成 PDF 檔案，此後無法讀取
      - JSON：儲存成 JSON 檔案，可以重複讀取
...
- 透明白板
  ...
  - 模式
    ...
    - 注意事項
      - 當模式切換時在 Parasite 的 UI 完成對應的變動前請勿將 Google Meet 最小化
...
- 彈幕
  ...
  - 彈幕 demo 影片
    [![Google-meet Parasite 互動式透明白板 - 彈幕demo](https://img.youtube.com/vi/1A1PEL5SByI/maxresdefault.jpg)](https://youtu.be/PMJb5tDuwrc)
